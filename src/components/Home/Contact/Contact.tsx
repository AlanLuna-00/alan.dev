  ...
  return (
    <div className="text-center mt-4 pb-5">
      ...
      <Link
        ...
        className="bg-white text-black px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-200 transition duration-300 ml-4"
      >
        <MailIcon className="h-5 w-5 inline-block" /> Contact
      </Link>
      <div>{/* linkedIn link and github link and icons */}</div>
    </div>
  );
};
